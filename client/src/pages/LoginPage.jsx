    ...
    <div className="min-h-screen bg-theme-primary flex flex-col items-center justify-center px-4">
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-4">
        ...
        <div className="flex items-center gap-3 my-2">
          <div className="flex-1 h-px bg-theme-tertiary"></div>
          <span className="text-theme-muted text-xs">OR</span>
          <div className="flex-1 h-px bg-theme-tertiary"></div>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 flex items-center justify-center gap-3 bg-theme-tertiary border border-theme rounded-lg text-theme-primary font-semibold hover:bg-theme-secondary transition disabled:opacity-50"
        >
